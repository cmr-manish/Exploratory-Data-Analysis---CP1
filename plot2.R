...
plot(date_subset$dateTime, date_subset$Global_active_power, type = "l", xlab = "", ylab = "Global Active Power (kilowatts)", col = "black")
dev.copy(png,"plot2_3.png", width=480, height=480)
dev.off()